...
/**
 * DishIngredientSearch represents the model behind the search form about `common\modules\selectingDishes\models\DishIngredient`.
 */
class DishIngredientSearch extends DishIngredient
{
    ...
    {
        $query = DishIngredient::find()->groupBy('dish_id');
